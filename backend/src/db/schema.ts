...
export const createTables = (db: Database.Database) => {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS fahrzeuge (
      ...
      versicherungsAnsprechpartner TEXT,
      versicherungsEmail TEXT,
      versicherungsTelefon TEXT,
      deckungssumme REAL,
      ...
      reifenMarkeSommer TEXT,
      reifenModellSommer TEXT,
      reifenGroesseSommer TEXT,
      reifenMontagedatumSommer TEXT,
      reifenKmBeiMontageSommer REAL,
      reifenProfiltiefeVLSommer REAL,
      reifenProfiltiefeVRSommer REAL,
      reifenProfiltiefeHLSommer REAL,
      reifenProfiltiefeHRSommer REAL,
      reifenMarkeWinter TEXT,
      reifenModellWinter TEXT,
      reifenGroesseWinter TEXT,
      reifenMontagedatumWinter TEXT,
      reifenKmBeiMontageWinter REAL,
      reifenProfiltiefeVLWinter REAL,
      reifenProfiltiefeVRWinter REAL,
      reifenProfiltiefeHLWinter REAL,
      reifenProfiltiefeHRWinter REAL,
